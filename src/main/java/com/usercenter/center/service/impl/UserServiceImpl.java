package com.usercenter.center.service.impl;
...
import com.usercenter.center.mappers.UserMapper;
...
import static com.usercenter.center.contant.UserConstant.USER_LOGIN_STATE;
        ...
        implements UserService
{
    ...
    public boolean valideUserRole(HttpServletRequest request)
    {
        ...
        //2.验证用户权限
        return user.getRole() != UserConstant.ADMIN_ROLE ||user == null;
